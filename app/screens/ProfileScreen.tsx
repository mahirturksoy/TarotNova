      ...
      <LinearGradient colors={['#2b173f', '#1d112b', '#2b173f']} style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.section}><Text style={styles.sectionTitle}>{t('profile.account.title')}</Text><View style={styles.ritualContainer}>
                ...
                <TouchableOpacity style={styles.accountRow} activeOpacity={0.7} onPress={() => Linking.openURL('https://mahirturksoy.github.io/TarotNova/terms.html')}><View style={styles.ritualInfo}><Text style={styles.ritualSymbol}>📜</Text><Text style={styles.ritualLabel}>{t('profile.account.terms')}</Text></View><Text style={styles.ritualArrow}>›</Text></TouchableOpacity>
                <TouchableOpacity style={styles.accountRow} activeOpacity={0.7} onPress={() => Linking.openURL('https://mahirturksoy.github.io/TarotNova/privacy-policy.html')}><View style={styles.ritualInfo}><Text style={styles.ritualSymbol}>☗</Text><Text style={styles.ritualLabel}>{t('profile.account.privacy')}</Text></View><Text style={styles.ritualArrow}>›</Text></TouchableOpacity>
